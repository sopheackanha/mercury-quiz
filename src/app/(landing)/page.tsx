...
export default function Home() {
  return (
    <main>
      <div className="bg-[url(/home-bg.png)] bg-cover bg-no-repeat bg-center h-screen w-full layout">
        ...
        <div className="grid grid-cols-5 h-screen">
          ...
          <div className="col-span-2 flex items-center justify-center">
            <div className="text-center space-y-8 flex flex-col justify-center items-center">
              ...
              Take quizzes to test your knowledge and create your own quiz with Sailor Mercury {"><"}
              </p>
